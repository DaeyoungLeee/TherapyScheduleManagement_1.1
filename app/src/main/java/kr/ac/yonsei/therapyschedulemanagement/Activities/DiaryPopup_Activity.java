...
import static kr.ac.yonsei.therapyschedulemanagement.Fragments.Diary_Fragment.horizontalCalendar;
import static kr.ac.yonsei.therapyschedulemanagement.Fragments.Diary_Fragment.linear_empty;

public class DiaryPopup_Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DiaryPopup_Activity.this);
                builder.setTitle("경고");
        ...
        btn_okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status != null) {
                    ...
                    Toast.makeText(DiaryPopup_Activity.this, "소중한 정보가 저장되었습니다.", Toast.LENGTH_SHORT).show();
                    finish();
                    horizontalCalendar.refresh();
                } else {
                    Toast.makeText(DiaryPopup_Activity.this, "상태를 체크해주세요", Toast.LENGTH_SHORT).show();
                }
